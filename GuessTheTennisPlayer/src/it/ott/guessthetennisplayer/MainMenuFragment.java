...
/**
 * Fragment with the main menu for the game. The main menu allows the player to choose a gameplay mode (Easy or Hard), and click the buttons to
...
public class MainMenuFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		final int[] CLICKABLES = new int[] { R.id.easy_mode_button, R.id.hard_mode_button, R.id.show_achievements_button,
				R.id.show_leaderboards_button, R.id.sign_in_button, R.id.sign_out_button };
	...
	void updateUi() {
		...
		getActivity().findViewById(R.id.sign_in_bar).setVisibility(mShowSignIn ? View.VISIBLE : View.GONE);
		getActivity().findViewById(R.id.sign_out_bar).setVisibility(mShowSignIn ? View.GONE : View.VISIBLE);
	}
