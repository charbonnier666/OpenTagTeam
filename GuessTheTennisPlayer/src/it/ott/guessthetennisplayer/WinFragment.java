...
/**
 * Fragment that shows the 'You won' message. Apart from congratulating the user on their heroic number typing deeds, this screen also allows
 * the player to sign in if they are not signed in yet.
 * 
...
public class WinFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.frag_win, container, false);
	...
	void updateUi() {
		...
		if (explainTv != null)
			explainTv.setText(mExplanation);
