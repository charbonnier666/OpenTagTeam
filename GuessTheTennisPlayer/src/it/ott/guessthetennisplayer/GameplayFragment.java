...
/**
 * Fragment for the gameplay portion of the game. It shows the keypad where the user can request their score.
 * 
...
public class GameplayFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.frag_gameplay, container, false);
	...
	void updateUi() {
		...
		if (scoreInput != null)
			scoreInput.setText(String.format("%04d", mRequestedScore));
	}
